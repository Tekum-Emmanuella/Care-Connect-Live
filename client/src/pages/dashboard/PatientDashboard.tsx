      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-none shadow-sm bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-900/10">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-blue-700">{user.bloodType}</div>
          ...
          <Card className="border-none shadow-sm bg-gradient-to-br from-purple-50 to-purple-100/50">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-700">{nextAppointment.date}</div>
              <p className="text-xs text-purple-600/80 mt-1">{nextAppointment.time} with {nextAppointment.doctor.name}</p>
            </CardContent>
          </Card>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {appointments.map((apt) => (
                <div key={apt.id} className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-start gap-4 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 flex items-center gap-1 mt-1">
                      <User className="w-3 h-3" /> {apt.doctor.name}
                    </p>
          ...
          <div className="space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-r from-primary to-teal-600 text-white shadow-lg shadow-primary/20 mt-4 relative overflow-hidden group cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <Button variant="secondary" size="sm" className="rounded-lg bg-white/20 text-white hover:bg-white text-primary hover:text-primary border-none backdrop-blur-sm">
